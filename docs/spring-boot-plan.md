...
**Exactly what to change/add**
- [ ] Choose a root package and apply it consistently (example: `com.sentimentscribe`).
- [ ] Move current packages under the root (use IDE refactor; keep logical boundaries):
  - [ ] `app` → `com.sentimentscribe.app`
  - [ ] `use_case` → `com.sentimentscribe.usecase`
  - [ ] `interface_adapter` → `com.sentimentscribe.adapter` (or `com.sentimentscribe.web` once controller layer exists)
  - [ ] `data_access` → `com.sentimentscribe.data`
  - [ ] `entity` → `com.sentimentscribe.domain`
...
**Files to create/modify**
- Create: `src/main/java/com/sentimentscribe/SentimentScribeApplication.java`
- Create: `src/main/java/com/sentimentscribe/web/HealthController.java` (or equivalent)
...
- Create: `src/main/java/com/sentimentscribe/config/**` (Spring configuration as needed)
- Modify: `src/main/java/com/sentimentscribe/**` (constructors and wiring updates)
...
**Files to create/modify**
- Create: `src/main/java/com/sentimentscribe/web/**` (controllers)
- Create: `src/main/java/com/sentimentscribe/web/dto/**`
- Create: `src/main/java/com/sentimentscribe/service/**`
- Create/Modify: `src/main/java/com/sentimentscribe/data/**`
...
**Files to create/modify**
- Create: `src/test/java/com/sentimentscribe/SentimentScribeApplicationContextTest.java`
- Create: `src/test/java/com/sentimentscribe/web/HealthControllerTest.java` (or another controller smoke test)
- Create: `src/test/java/com/sentimentscribe/web/EntriesApiIntegrationTest.java` (example)
