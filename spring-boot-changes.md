...
### Key technical details and decisions
- Context load test: `MoodVerseApplicationContextTest`
...
### Files added / modified / deleted
- `src/test/java/com/moodverse/MoodVerseApplicationContextTest.java`
- `src/test/java/com/moodverse/web/HealthControllerTest.java`
- `src/test/java/com/moodverse/web/EntriesApiIntegrationTest.java`

### Verification notes
- `mvn -q test`: not run
- Backend runs independently: not run
